...
//console.log(arrayRandElement(possible_name))
//console.log(arrayRandElement(possible_price))
 
function create_order_item (arr1,arr2) {
   
    all_items.add(new Order_item(all_items.order_list.length+1,arrayRandElement(possible_name),arrayRandElement(possible_price),'1'))
}
...
{   
    ...
    if (basket.order_list.length) {
      basket.show(order)
        ...
        if (all_items.order_list.length > 10) {
